# Agent Federation Protocol (AFP) — v3.28
...
This is the markdown rendition of the full spec (Revision 3.29). Reading order:
...
| [scenarios/](scenarios/) | Spec-test scenarios — each walks a real workload end to end and ends with a verdict of what held and what strained. Eleven of them, **all 57 findings closed**; the [support index](scenarios/README.md#is-this-workload-supported) says which decision closed each and gives the command to watch each workload run |
| [adr/](adr/) | Architecture decision records — [ADR-0001](adr/0001-p1-stack.md): the P1 technology stack · [ADR-0002](adr/0002-p2-hub-and-crdt-stack.md): the P2 hub & CRDT stack · [ADR-0003](adr/0003-p3-allocation-stack.md): the P3 allocation stack · [ADR-0004](adr/0004-solo-foundation-hardening.md) (built): solo-foundation hardening before federation · [ADR-0005](adr/0005-operators-are-equal.md) (accepted): operators are equal against a hub · [ADR-0006](adr/0006-checkable-actuation.md) (built): checkable actuation · [ADR-0007](adr/0007-supersession.md) (built): supersession · [ADR-0008](adr/0008-p4-federation-stack.md) (built): the P4 federation stack · [ADR-0009](adr/0009-federated-replay.md) (built): federated replay & lawful redaction · [ADR-0010](adr/0010-pinning-without-an-auction.md) (built): pinning without an auction · [ADR-0011](adr/0011-supersession-meets-the-irreversible-world.md) (built): supersession meets the irreversible world · [ADR-0012](adr/0012-the-long-horizon.md) (built): the long horizon · [ADR-0013](adr/0013-authorized-fetch.md) (built): authorized fetch · [ADR-0014](adr/0014-p5-shared-hub-stack.md) (built): the P5 shared-hub stack · [ADR-0015](adr/0015-the-case-file-at-n-parties.md) (built): the case file at N parties · [ADR-0016](adr/0016-p5-transport.md) (built): the P5 transport · [ADR-0017](adr/0017-standards-conformance.md) (in progress): standards conformance · [ADR-0018](adr/0018-the-round-as-a-commitment.md) (built): the round as a commitment · [ADR-0019](adr/0019-acting-on-a-decision.md) (built): acting on a decision · [ADR-0020](adr/0020-p6-hardened-round-stack.md) (built): the P6 hardened-round stack · [ADR-0021](adr/0021-conviction-to-consequence.md) (partly built): conviction to consequence |
