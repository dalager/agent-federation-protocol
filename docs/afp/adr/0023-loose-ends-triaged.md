...
First movement 2026-09-04: **L1** (hub-scoped and transport keys outside `afp:keyHistory`)
is *part-closed* by [ADR-0026](0026-key-custody-and-the-signer-port.md) Decision 3 — the
keys are recorded; the interval check that row also asks for cannot fire until a
hub-scoped signature actually travels in a bundle. Every other row above is open.

| Slice | Rows | State |
|---|---|---|
| 1 | L6 L7 L8 L11 L12 L13 L15 | open |
| 2 | L1 L2 | open |
| 3 | L4 L5 L9 L10 L19 | open |
| 4 | L16 L17 L20 (L21) | open |
| campaign | L3 | open |
| docs | L14 | open |
